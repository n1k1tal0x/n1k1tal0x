...
**Telegram:** *@n1k1tal0h*  
**Телефон для связи (на незнакомый номер врятли отвечу):** +7 (999) 783 24-00 
...
### **WeatherBot (практика в PVS-Studio)**
...
### **Простая аналитика данных в Metabase (практика в GMCS)**
- Репозиторий: n1k1tal0x/gmcs_practica_2
- Стек: `Docker`, `Metabase`
- Описание: Развернул Metabase + Postgres через compose. Настроил запросы (сами запросы во многом делались через иишку, однако всё равно пришлось разобраться, что и как в Metabase воркать, а иишка уже сам SQL делала) и их визуализацию в Metabase

### **Твикер для игры Rust**
...
- Много фикеш для игры, также сбор информации об системе (windows)
